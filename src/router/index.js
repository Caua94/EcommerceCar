...
const routes = [
  ...
  { path: "/confirmation/:transactionId'", name: "confirmation", component: OrderConfirmation, props:true},
  { path: "/checkout", name: "Checkout", component: Checkout },
  {path: '/pay-order/:id', name: 'pay-order',component: PayOrder, props: true },
